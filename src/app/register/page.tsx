...
import { Eye, EyeOff, Mail, Lock, User, Sun, Moon, Server, X, Bot } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4 py-8 relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">Start tracking your finances today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-400">
                I agree to the{" "}
                <button type="button" onClick={() => alert("Terms of Service - Coming soon!")} className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 cursor-pointer">
                  Terms of Service
                </button>{" "}
                and{" "}
                <button type="button" onClick={() => alert("Privacy Policy - Coming soon!")} className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 cursor-pointer">
                  Privacy Policy
                </button>
              </label>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              type="button"
              onClick={() => alert("Google signup - In a real app, this would redirect to Google's OAuth page")}
            ...
            <button 
              type="button"
              onClick={() => alert("GitHub signup - In a real app, this would redirect to GitHub's OAuth page")}
              className="flex items-center justify-center gap-2 py-3 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer"
            >
